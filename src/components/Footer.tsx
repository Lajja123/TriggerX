  ...
  return (
    <>
      <div className="relative flex items-center justify-center flex-col">
        <div className="flex items-center justify-between  px-4 mb-4 flex-row w-[70%] ">
          <div className="flex items-center justify-between  px-4 mb-4 flex-col gap-4 ">
            <div className="text-center pb-3 sm:p-3 md:pb-0 lg:p-0">
          ...
          <div className="flex justify-center space-x-6 gap-4 flex-col lg:my-20 md:my-20 my-20 sm:my-20 ">
            {" "}
            <div className="flex justify-end space-x-6 gap-4">
